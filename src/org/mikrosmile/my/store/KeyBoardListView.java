...
public class KeyBoardListView extends ArrayAdapter<News> {
    Activity context;
    List<News> news;
 
    public KeyBoardListView(Activity context, List<News> news) {
        super(context, R.layout.kb_details, news);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.kb_details, null);
