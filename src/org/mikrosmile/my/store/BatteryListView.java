...
public class BatteryListView extends ArrayAdapter<News> {
    Activity context;
    List<News> news;
 
    public BatteryListView(Activity context, List<News> news) {
        super(context, R.layout.battery_details, news);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.battery_details, null);
