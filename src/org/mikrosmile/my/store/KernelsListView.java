...
public class KernelsListView extends ArrayAdapter<News> {
    Activity context;
    List<News> news;
 
    public KernelsListView(Activity context, List<News> news) {
        super(context, R.layout.kernels_details, news);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.kernels_details, null);
