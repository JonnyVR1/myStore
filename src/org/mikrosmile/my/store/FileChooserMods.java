...
public class FileChooserMods extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        currentDir = new File("/sdcard/MyStore/MODs/");
        fill(currentDir);
        SetupActionBar();
    }
    private void fill(File f)
    {
        File[]dirs = f.listFiles();
         ...
         adapter = new FileArrayAdapter(FileChooserMods.this,R.layout.file_view,dir);
    ...
    {
        {
        	String[] commands = {"adb shell", "echo 'boot-recovery ' > /cache/recovery/command",
					"adb shell", "echo '--update_package=SDCARD:"  + "/MyStore/MODs/" + o.getName() + "'" + ">> /cache/recovery/command",
